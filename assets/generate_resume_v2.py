...
def build():
    ...
    pdf.set_text_color(*pdf.LINK_BLUE)
    niappa_url = "https://niappa-restaurant.vercel.app/"
    pdf.cell(pdf.get_string_width(niappa_url), 3.5, niappa_url, link=niappa_url)
    pdf.set_text_color(80, 80, 80)
    pdf.cell(pdf.get_string_width(" (Niappa POS) | "), 3.5, " (Niappa POS) | ")
    pdf.set_text_color(*pdf.LINK_BLUE)
    ohr_url = "https://oceans-hr.vercel.app/"
    pdf.cell(pdf.get_string_width(ohr_url), 3.5, ohr_url, link=ohr_url)
    pdf.set_text_color(80, 80, 80)
    pdf.cell(pdf.get_string_width(" (Oceans HR ATS)"), 3.5, " (Oceans HR ATS)")
    pdf.ln(3.5)
    pdf.ln(0.5)
    ...
    pdf.sub_header("Private repos - Internal platform (NestJS + Next.js + Python/FastAPI)")
    pdf.ln(0.5)
    ...
    pdf.output("Jonathan-Sanso-Full-Stack-AI-Engineer.pdf")
